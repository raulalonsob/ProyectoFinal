...
public interface MantenimientoRepository extends CrudRepository<MantenimientoEntity, String> {
	@Query(value = "select new com.raul.taller.dtos.MantenimientoRequestDTO (a.id_mantenimientos, a.matricula, a.fecha, a.kilometros, a.cantidad_ruedas, a.posicion_rueda, a.id_ruedas, a.importe, r.marca, r.modelo) "
